...
services:
  mikrotik-backup:
    image: ghcr.io/thekoma/mikrotik-backup/app:2024.11.4  # Replace with desired version
...
For example, to install version 2024.11.4:
```bash
helm install mikrotik-backup oci://ghcr.io/thekoma/mikrotik-backup/charts --version 2024.11.4
```
